								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
                                                                                    ...
                                                                                    <form action="contratoControlador" method="POST" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtidvehiculo" value="" pleceholder="Marca">   
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtidconductor" value="" pleceholder="Referencia">   
                                                                                            </div>
                                                                                        </div>
