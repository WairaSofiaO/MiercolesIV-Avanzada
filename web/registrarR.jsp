								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
                                                                                    ...
                                                                                    <form action="rutaControlador" method="POST" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtestacion" value="" pleceholder="Estacion">   
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtidvehiculo" value="" pleceholder="Id vehiculo">   
                                                                                            </div>
                                                                                        </div>
