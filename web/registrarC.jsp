								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
                                                                                    ...
                                                                                    <form action="tipoVehiculoControlador" method="POST" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            <Label class="col-sm-3 control-label no-padding-right">
                                                                                                Tipo vehículo
                                                                                            </Label>
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtTipoVehiculo" value="" pleceholder="Id tipo de vehículo">   
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtNombreTipoV" value="" pleceholder="Nombre del tipo de vehículo">   
                                                                                            </div>
                                                                                        </div>
